...
```bash
ORG=bdpiparva REPO_NAME=plugin-api.go.cd GITHUB_USER=foo GITHUB_TOKEN=bar NEXT_VERSION=18.12.0 VERSION_TO_RELEASE=18.11.0 rake bump_docs_version
```
...
```bash
REPO_NAME=plugin-api.go.cd rake bump_docs_version
```
